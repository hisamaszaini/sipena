...
<div id="modal-form" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-4xl mx-auto max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center mb-4">
            <h3 id="modal-title" class="text-xl font-bold text-white">Tambah Admin</h3>
        ...
        <form id="admin-form" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-1">
                <label for="nama" class="block text-white mb-1">Nama Admin</label>
...
<div id="view-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
    <div class="bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-4xl mx-auto max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-xl font-bold text-white">Detail Admin</h3>
...
<script>
    $(document).ready(function () {
        ...
        $('#admin-form').submit(function (e) {
            e.preventDefault();
            var id = $('#admin-id').val();
            var url = id ? "{{ route('admin.update', ':id') }}".replace(':id', id) : "{{ route('admin.store') }}";
